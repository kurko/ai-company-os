...
│   │   │── # Departments: eng, prod, mkt, fin, legal, ops, hr
│   │   │── # ═══════════════════════════════════════════════════════════
│   │   │
│   │   │── # --- Executive ---
│   │   ├── role-exec-ceo.md
...
│   │   ├── file-reader.md              # Context-safe file reading
│   │   │
│   │   │── # ═══════════════════════════════════════════════════════════
...
| Consultants | `consultant-{firstname}-{lastname}.md` | `consultant-ryan-singer.md` |
